...
.mj-column-per-100 { width:100% !important; max-width: 100%; }
    ...
    ><span style="font-size: 11px">Fotolog</span></div>
    ...
    ><p><span style="color: rgb(106, 138, 162);"><span style="font-weight: bold;"><span style="font-size: 16px;">Welcome to Fotolog</span></span>
          </span>
        </p></div>
    ...
    >
      <tr>
        ...
        >
          <a
             href="https://fotolog-ironhack.herokuapp.com/users/activate/${token}" style="display:inline-block;background:#c7896f;color:#FFFFFF;font-family:Ubuntu, Helvetica, Arial, sans-serif, Helvetica, Arial, sans-serif;font-size:13px;font-weight:normal;line-height:120%;margin:0;text-decoration:none;text-transform:none;padding:10px 25px;mso-padding-alt:0px;border-radius:3px;" target="_blank"
          >
            Activate account
          </a>
        </td>
